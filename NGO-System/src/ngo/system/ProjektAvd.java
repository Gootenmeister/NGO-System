 ...
 * @author drakm
 */
public class ProjektAvd extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(ProjektAvd.class.getName());
    private InfDB idb;
    ...
    public static void main(String args[]) {
        ...
        //java.awt.EventQueue.invokeLater(() -> new ProjektAvd().setVisible(true));
    }
